import {Order as OrderMapping, OrderItem as OrderItemMapping} from './models.js'
...
class Order {
    async getAll(userId = null) {
        ...
        return await OrderMapping.findAll(options)
    }
    ...
    async create(data) {
        ...
        return await OrderMapping.findByPk(order.id, {
            include: [
